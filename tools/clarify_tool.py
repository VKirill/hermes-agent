...
CLARIFY_SCHEMA = {
    ...
    "description": (
        ...
        "`choices` or `options` parameters — NEVER enumerate the options inside the `question` "
        "text. The UI renders choices/options as selectable interface elements; options written "
