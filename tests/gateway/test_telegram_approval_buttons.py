...
class TestTelegramExecApproval:
    ...
    async def test_send_update_prompt_escapes_dynamic_prompt(self):
        ...
        assert result.success is True
        assert "MarkdownV2" in str(sent["parse_mode"]) or "MARKDOWN_V2" in repr(sent["parse_mode"])
...
class TestTelegramApprovalCallback:
    ...
    async def test_approval_callback_escapes_dynamic_user_name(self):
        ...
        assert "MarkdownV2" in str(edit_kwargs["parse_mode"]) or "MARKDOWN_V2" in repr(edit_kwargs["parse_mode"])
