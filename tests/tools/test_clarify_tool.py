...
class TestClarifyToolChoicesValidation:
    ...
    def test_choices_trimmed_to_max(self):
        ...
        many_choices = [f"choice-{i}" for i in range(MAX_CHOICES + 3)]
...
class TestClarifySchema:
    ...
    def test_max_choices_is_twelve(self):
        """MAX_CHOICES constant should be 12 (adapters paginate 6/page)."""
        assert MAX_CHOICES == 12
