...
def _build_server() -> Any:
    ...
    for name in EXPOSED_TOOLS:
        ...
        # FastMCP wants a Python callable. Build a closure that dispatches via
        # handle_function_call (STATELESS — agent-level tools are excluded by
        # the curated list), wraps untrusted results in the shared promptware
        # defense, and exposes a signature synthesized from the JSON schema.
