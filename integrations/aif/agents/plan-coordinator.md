...
The user provides a planning request — the same input they would give to the `aif-plan` skill. Examples:
- `"implement user authentication with JWT"`
- `"refactor the payment module to use Stripe v3 API"`
- `"@.hermes-dev/plans/feature-auth.md"` (polish an existing plan)
