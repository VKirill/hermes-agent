...
**Result:** `.hermes-dev/reference/zod-validation.md`
...
**Result:** `.hermes-dev/reference/astro-framework.md`
...
**Result:** `.hermes-dev/reference/internal-api.md`
...
**Result:** in an interactive session, the skill asks what topic the user
needs a reference for, whether they have specific URLs or want the AI to
search, and what aspects matter most. Then proceeds with the standard
workflow. (A kanban worker never enters interactive mode — it blocks with
"sources not specified" instead.)
...
```
.hermes-dev/reference/kubernetes/
