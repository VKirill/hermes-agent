...
def main():
    ...
    print("\nTo adopt a skill in Hermes:")
    print("  1. Download/clone it into a staging directory (NOT ~/.hermes/skills/ yet)")
    print("  2. Security-scan it: python3 ~/.hermes/skills/aif-skill-generator/scripts/security-scan.py <staging-dir>")
    print("  3. Review every file manually (Level 2), then copy the folder to ~/.hermes/skills/<name>/")
    print("  4. Verify: hermes skills list")
