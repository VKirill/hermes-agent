...
## Generating Rules from Setup

During Setup (Step 2 of the loop), rules are generated from user answers (interactive) or derived from the kanban task body (worker path):
