...
def run_job(
    ...
    try:
        ...
        try:
            ...
            # Keep the provider/model pair atomic for fallback and drift
            # accounting; changing only the provider can silently reroute a
            # paid model through another backend.
            primary_provider_for_drift = (
