...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_profile_command(self, event: MessageEvent) -> str:
        ...
        Under multiplexing, the displayed profile/home comes from the source
        scope rather than the multiplexer's process-level profile.
        """
